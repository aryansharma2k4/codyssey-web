...
  standings: StandingsData | null;
  lastUpdatedAt: string | null; // <-- ADDED
}

// --- MODIFIED FUNCTION SIGNATURE ---
export default function HeroSection({ standings, lastUpdatedAt }: HeroSectionProps) {
  return (
...
        <HeroContent standings={standings} />
        ...
        {/* --- ADDED TIMESTAMP --- */}
        {lastUpdatedAt && (
          <div className="mt-4 text-gray-400 text-xs md:text-sm font-mono">
